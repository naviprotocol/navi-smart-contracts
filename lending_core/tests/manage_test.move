...
module lending_core::manage_test {
    ...
    public fun test_flash_loan_should_correctly_with_larger_rate()
    {
        ...
        test_scenario::next_tx(&mut scenario, OWNER);
        {
            ...
            let actual_amount = lending_core::ray_math::ray_div((expect_supply_fee as u256), _before_supply_index);// 2999700000000 / 1000004800000000000000000000 = 2999685601509
            print(&actual_amount);
            print(&total_supply);//1e15
            print(&_before_supply_index);// 1000004800000000000000000000
            let expect_supply_index_diff = lending_core::ray_math::ray_mul(lending_core::ray_math::ray_div(actual_amount, total_supply), _before_supply_index);//2999.7 * 1e21
    ...
    public fun test_flash_loan_after_set_rate_integration() {
       ...
       // deposit 10k USDT
        ...
        test_scenario::next_tx(&mut scenario, OWNER);
        {
            ...
            let expect_supply_index_diff = lending_core::ray_math::ray_mul(lending_core::ray_math::ray_div(actual_amount, total_supply), _before_supply_index);
